        ...
        <div style="float:right;margin-right:10px;">[<a href="<?php echo $this->Html->url(array('controller'=>'Users','action'=>'admin_profileedit',$profile['User']['id'])); ?>" style="text-align:right;">Edit</a>]</div>
         ...
         <div class="formRow">
             ...
             <div class="formRow">
                ...
                <div class="formRow">
                    <div class="grid3"><label><b>Home Town:</b></label></div>
                    <div class="grid9">
                    <?php if($profile['User']['home_town']== NULL || $profile['User']['home_town']=='0'){echo "Not Mentioned";}else{ echo $profile['User']['home_town']; } ?>
                    </div>
