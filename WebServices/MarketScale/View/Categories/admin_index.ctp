     ...
     <div class="nNote nSuccess" id="flash">
      ...
      <div class="widget check grid6">
        ...
        <div id="dyn" class="hiddenpars">
			...
			<td><?php echo h($category['City']['name']); ?></td>
			<td><?php echo $this->Html->image(FULL_BASE_URL.$this->webroot.'files/categoryimages/'.$category['Category']['image'],array('width'=>'100')); ?></td>
