...
$this->Session->setFlash('Your status is not active.');
	...
	public function admin_dashboard(){
	 ...
	 $y = $this->User->find('all',array('conditions'=>array('User.usertype_id'=>8)));
    	$this->set("use_count", $y);

		$this->loadModel('User');
		$restCount=$this->User->find('all',array('conditions'=>array('User.usertype_id'=>7)));
		$this->set('restCount',$restCount);
