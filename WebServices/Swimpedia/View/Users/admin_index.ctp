									...
									<div class="row">
										...
										<div class="col-md-8">
											<div class="toolbar-btn-action">
												...
												<a href="<?php echo $this->Html->url(array('controller'=>'Users','action'=>'user_csv')); ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Download CSV</a>	
									...
									<table data-sortable class="table table-hover table-striped  tDefault tMedia">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $i; ?></td>
												<td><img src="<?php echo $this->webroot.'files' . DS . 'profileimage' . DS . $user['User']['profile_image'];?>"  height="50" height="50"></td>
												<td><strong><?php echo h($user['User']['username']); ?></strong></td>
												<td><a href="mailto:#"><?php echo h($user['User']['email']); ?></a></td>
												<td><span class="label label-<?php if($user['User']['status'] == '0') {echo "warning";} else { echo "success";}?>"><?php if($user['User']['status'] == '0'){echo "Deactivated";}else if($user['User']['status'] == '1'){echo "Activated";} ?></span></td>
												<td>
												<form></form>
													<div class="btn-group btn-group-xs">
														<!--<a href="<?php //echo $this->Html->url(array('action' => 'view', $user['User']['id'])); ?>" data-toggle="tooltip" title="Off" class="btn btn-default"><i class="fa fa-power-off"></i></a>-->
														<a href="<?php echo $this->Html->url(array('action' => 'activate', $user['User']['id'])); ?>"data-toggle="tooltip" title="Update" class="btn btn-default"><i class="fa fa-power-off"></i></a>
														<a href="<?php echo $this->Html->url(array('action' => 'edit', $user['User']['id'])); ?>"data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $this->Html->url(array('action' => 'delete', $user['User']['id'])); ?>"data-toggle="tooltip" title="Delete" class="btn btn-default"><i class="fa fa-remove"></i></a>
														<a href="<?php echo $this->Html->url(array('action' => 'check_answer', $user['User']['id'])); ?>"data-toggle="tooltip" title="Check Answer" class="btn btn-default"><i class="fa fa-paper-plane"></i></a>
														<!--<a href="<?php //echo $this->Html->url(array('action' => 'right_answer', $user['User']['id'])); ?>"data-toggle="tooltip" title="Right Answer" class="btn btn-default"><i class="fa fa-paper-plane"></i></a>
														<a href="<?php //echo $this->Html->url(array('action' => 'wrong_answer', $user['User']['id'])); ?>"data-toggle="tooltip" title="Wrong Answer" class="btn btn-default"><i class="fa fa-bug"></i></a>-->
													</div>
												</td>
											</tr>
											<?php $i++; endforeach; ?>
