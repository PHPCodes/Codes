...
<div class="topbar">
    <div class="topbar-left">
        <div class="logo">
            <h2 style="text-align:center"><a href="<?php echo $this->Html->url(array('controller'=>'users','action'=>'admin_dashboard')); ?>">
			<span style="color:green">S</span><span style="color:white">wim<span style="color:green">P</span style="color:white">edia  </span></a>
			</h2>
        </div>
            ...
            <div class="navbar-collapse2">
                ...
                <ul class="nav navbar-nav navbar-right top-navbar">
                        ...
                        <ul class="dropdown-menu dropdown-message">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="<?php echo $this->webroot; ?>images/users/chat/2.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="<?php echo $this->webroot; ?>images/users/chat/1.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <img src="<?php echo $this->webroot; ?>images/users/chat/3.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                    ...
                    <li class="dropdown topbar-profile">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="rounded-image topbar-profile-image"><img src="<?php echo $this->webroot.'files' . DS . 'profileimage' . DS . $profile_image; ?>"></a></span> <?php  echo $this->Session->read('Auth.User.first_name'); ?> <strong><?php  echo $this->Session->read('Auth.User.last_name'); ?></strong> <i class="fa fa-caret-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo $this->Html->url(array('controller'=>'Users','action'=>'admin_profile')); ?>">My Profile</a></li>
                            <li><a href="<?php echo $this->Html->url(array('controller'=>'Users','action'=>'admin_changepass')); ?>">Change Password</a></li>
                            <li><a href="<?php echo $this->Html->url(array('controller'=>'Sitesettings','action'=>'admin_index')); ?>"><i class="fa fa-cog"></i> Account Setting</a></li>
                            <li class="divider"></li>                       
                            <li><a href="<?php echo $this->Html->url(array('controller'=>'Users','action'=>'admin_logout')); ?>" class="md-trigger" data-modal="logout-modal"><i class="icon-logout-1"></i> Logout</a></li>
                        </ul>
                    </li>
