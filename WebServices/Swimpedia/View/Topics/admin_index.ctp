        ...
        <div class="content-page">
            <div class="content">
				...
				<div class="page-heading">
            		...
            		<h3>Dashboard <i class='icon-right-open-2'></i>Topic Management</h3> 
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-header transparent">
								<h2><strong> Topic </strong> Management </h2>
							...
							<div class="widget-content">
								<div class="data-table-toolbar">
									<div class="row">
										<div class="col-md-4">
											<?php echo $this->Form->create('Topic', array('controller'=>'Topics','action'=>'index','id'=>'searchform')); ?>
											<!--form role="form"-->
										...
										<div class="col-md-8">
											<div class="toolbar-btn-action">
												<a href="<?php echo $this->Html->url(array('controller'=>'Topics','action'=>'admin_add')); ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add new</a>																
								...
								<?php  echo $this->Form->create('User',array('id' => 'mbc')); ?>
									<table data-sortable class="table table-hover table-striped  tDefault tMedia">
										...
										<tbody>
											...
											<tr>
												<!--<td><?php echo $this->Form->checkbox("use"+$user['Topic']['id'],array('value' => $user['Topic']['id'],'class'=>'checkAll')); ?></td>-->
												<td><?php echo $i; ?></td>
												<td><strong><?php echo h($user['Topic']['name']); ?></strong></td>
												<td><span rel="<?php echo $user['Topic']['id']; ?>" style="cursor:pointer;" class="status label label-<?php if($user['Topic']['status'] == '0') {echo "warning";} else { echo "success";}?>"><?php if($user['Topic']['status'] == '0'){echo "Deactivated";}else if($user['Topic']['status'] == '1'){echo "Activated";} ?></span></td>
												<td>
												<form></form>
													<div class="btn-group btn-group-xs">
														<a href="<?php echo $this->Html->url(array('action' => 'edit', $user['Topic']['id'])); ?>"data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $this->Html->url(array('action' => 'delete', $user['Topic']['id'])); ?>" data-toggle="tooltip" title="Delete" class="btn btn-default"><i class="fa fa-remove"></i></a>
													</div>
												</td>
											</tr>
											<?php $i++; endforeach; ?>
