	...
	<div class="content-page">
		<div class="content">
			...
			<div class="page-heading">
				<h1><i class='glyphicon glyphicon-user'></i> Question Management</h1>
				<h3>Dashboard <i class='icon-right-open-2'></i>Question Management</h3> 
				...
				<div class="col-md-12">
					<div class="widget">
						<div class="widget-header transparent">
							<h2><strong> Question </strong> Management </h2>
						...
						<div class="widget-content">
							<div class="data-table-toolbar">
								<!--<div class="row">-->
									<!--<div class="col-md-4">
										<?php //echo $this->Form->create('Topic', array('controller'=>'Topics','action'=>'check_answer','id'=>'searchform')); ?>
										<!--form role="form"-->
							...
							<tbody>
								...
								if (!empty($data)) { 
									...
									<tr>
										...
										<td><strong><?php echo h($user['QuestionAnswer']['right_answer']); ?></strong></td>
										<td>
											<span class="label label-<?php if($user['QuestionAnswer']['user_answer_status'] == '0') {echo "warning";} else { echo "success";}?>">
											<?php if($user['QuestionAnswer']['user_answer_status'] == '0'){echo "Wrong";}else if($user['QuestionAnswer']['user_answer_status'] == '1'){echo "Right";} ?></span></td>
										<!--<td>
										<form></form>
