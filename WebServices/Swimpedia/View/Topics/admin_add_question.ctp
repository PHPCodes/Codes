        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		...
            		<h3>Dashboard <i class='icon-right-open-2'></i>Questions Answers Management <i class='icon-right-open-2'></i>Add Questions Answers</h3> 				
				</div>
            	<!-- Page Heading End-->
				<div class="row">
					<div class="col-sm-12 portlets">
						<div class="widget">
							<div class="widget-header transparent">
								<h2><strong> Add </strong> Questions Answers</h2>
							...
							<div class="widget-content padding">
								...
								<!--form role="form" id="registerForm"-->
								  ...
								  <div class="form-group">
				                    ...
				                    <?php echo $this->Form->input('question', array('label'=>"",'type'=>'text','class'=>'form-control','required'));?>					
								  </div>	
									...
									<select class="form-control required select_fields_wrap" name="data[RightAnswer]">
										<option value="">Select</option>
