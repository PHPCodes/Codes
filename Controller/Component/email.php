...
class EmailComponent
{
   ...
   */
    var $from         = 'promatics.gurudutt@gmail.com';
    var $fromName     = "gurudutt";
    var $smtpUserName = 'promatics.gurudutt@gmail.com';  // SMTP username
    var $smtpPassword = '9911664331'; // SMTP password
    var $smtpHostNames= "ssl://smtp.gmail.com";  // specify main and backup server
    var $text_body = null;
    var $html_body = null;
    var $to = null;
    var $toName = null;
