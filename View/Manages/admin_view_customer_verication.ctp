	...
	<div id="page-content">
		<div id="page-content-wrapper">
			<div class="inner-page-title">
				<h2>View Customer verification Details</h2>
					...
					<div class="hastable">
						<table id="sort-table"> 
							<tbody> 
								<tr>
									<td class="test">
										<label>Customer verification id</label></td>
									<td><span ><?php
												echo	$reqdata['CustomerVarification']['id'];
								    ?></span></td>
								</tr>								
								<tr>
								   <td><label> Customer verification status</label></td>
								   <td>
									<span>
									<?php 
										if($reqdata['CustomerVarification']['varification_status'] == 'direct_varification')
										{
