...
$("#edit_uploadFile").live("change", function(){
	...
	$('.checkbox_list').live("click",".checkbox_list",function(){
		...
		if($(this).is(':checked'))			{
			alert("This is the main image that show on deal's deatil page page");
		}			
	});
...
<form id="frm" method="post" enctype="multipart/form-data" action="<?php echo HTTP_ROOT.'admin/Manages/editDeal_newsletter/'.base64_encode(convert_uuencode($member['Deal']['id']))?>">
	<fieldset>
                ...
                <h3>Deal Discount Option</h3>
                 <div class ="full_width">
                   <li>
					...
					<li>
                    <label class="desc">Discount option Selling Price 2:<em>*</em></label>
                    	<div class ="full_width">
                  	...
                  	<label class="desc">Discounted Selling Price 2<em>*</em></label>
						...
						<li>
                    <label class="desc">Discount Offered 2:<em>*</em></label>
                    	<div class ="full_width">
                  ...
                  <li>
					...
					<li>
                    <label class="desc">Discount option Selling Price 3:<em>*</em></label>
                    	<div class ="full_width">
                     	<input  class="field text full makeDiscount2" value="<?php echo @$member['DealOption'][2]['selling_price'];?>" name="data2[2][DealOption][selling_price]">
								<input  type="hidden" value="<?php echo @$member['Deal']['id'];?>" name="data2[2][DealOption][deal_id]">
				  	     	     ...
				  	     	     <li>
                  	<label class="desc">Discounted Selling Price 3<em>*</em></label>
                    	<div class ="full_width">
				  ...
				  <li>
                     <label class="desc">Discount Offered 3:<em>*</em></label>
                    	<div class ="full_width">
                    ...
                    <div class ="full_width">
                    		<textarea  class="field text full required tinymce" name="data[Deal][description]" rows="8"><?php echo @$member['Deal']['description'];?></textarea>
                    </div>
                  </li>
                  <li>
