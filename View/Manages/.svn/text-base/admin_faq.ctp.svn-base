	...
	<div id="page-content">
		<div id="page-content-wrapper">
			...
			<div class="inner-page-title">
				...
				<span class="ui-icon ui-icon-circle-close" style="float:left; padding:0px; border:none;"></span><span style="font-size:10px; width:115px; float:left; border:0px;"> - Delete FAQ</span>				
				</div>
