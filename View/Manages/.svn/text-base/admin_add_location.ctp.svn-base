...
<div id="page-layout">
	<div id="page-content">
		<div id="page-content-wrapper">
			...
			<form id="frm" method="post" enctype="multipart/form-data" action="<?php echo HTTP_ROOT;?>admin/Manages/addLocation">
				  <fieldset>
				<div class="content-box content-box-header" style="border:none;">
					...
					<div class="content-box-wrapper">
						...
						<li>
							...
							<div>
            				<input  class="field text full required" name="data[Location][name]" type="text" />						
							</div>
						</li>
						<li>
							<label class="desc">Active<em>*</em></label>
							<div>
								<select class="required" name="data[Location][active]" style="width:99%; height:36px;">
