         ...
         <?php /*?><?php echo $this->element('adminElements/table_head'); ?><?php */?>
			<table id="sort-table"> 
				...
				<tbody> 
					...
					?>
                <tr>
                      <td><?php echo $et['EmailTemplate']['title']; ?></td>
                        <?php
                             /*if($subadmin_type==1||@$modulepermissions['Email Templates']['module_edit']==1)
                			            {
                                 if($subadmin_type==1||($subadmin_type==2 && (@$modulepermissions['Email Templates']['edit_permission']==1)))
                        			       {*/
								if($subadmin_type==1||@$modulepermissions['Content Management']['module_edit']==1)
                			    {
                          			  ...
                          			  ?>   
                         	<td>
                        	<?php $tmpid = base64_encode(convert_uuencode($et['EmailTemplate']['id'])); ?>
                             	<a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/edit_template/".$tmpid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
             ...
             <?php echo $this->element('backend/table_head30'); ?>
