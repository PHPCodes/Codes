			...
			<table id="sort-table"> 
					...
					<tr>
						...
						<td>
							...
							<a title="View Sold Vouchers By Supplier" href="<?php echo HTTP_ROOT."admin/Manages/view_deal_vouchers/".$newsid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
