...
function searching()
{
   var t = new Date().getTime();
	...
	$.ajax({
		url:ajax_url+'admin/NewsLetters/dispatched_newsletters',
		type:'post',
         ...
         <div class="id_cont admin_search  member_search_management" style="" >
		        <form  method="post" action="" id="search">
				         <div class="search_input">	
							     ...
							     <div class="search_input">	
												<label>Start</label>
												<input style="margin-left:0px;margin-top: 0px;width: ;height: 21px; " class="field text StartDate datepicker" type="text"  name="data[StartDate]" readonly="readonly" onkeyup = "return handle(event);"/>
											</div>
												
											<div class="search_input">	
												<label style="margin-left:16px" >End</label>
												<input class="field text EndDate datepicker" type="text"  name="data[EndDate]" readonly="readonly"  style="margin-left:0px;margin-top: 0px;width: ;height: 21px; " onkeyup = "return handle(event);"/>
											</div>
