...
function searching()
{
	...
	$.ajax({
		url:ajax_url+'admin/Members/customers/',
		type:'post',
...
?>
		<div class="inner-page-title">
			...
			<span class="ui-icon ui-icon-pencil" style="float:left; padding:0px; border:none;"></span>
			<span style="font-size:10px; width:88px; float:left; border:0px;"> - Edit Member</span>
			<span class="ui-icon ui-icon-circle-close" style="float:left; padding:0px; border:none;"></span>
			<span style="font-size:10px; width:93px; float:left; border:0px;"> - Delete Member</span>
			<span class="ui-icon ui-icon-lightbulb" style="float:left; padding:0px; border:none;"></span>
			<span style="font-size:10px; width:120px; float:left; border:0px;"> - Status of Member</span>
			</div>             
         <span></span>
		</div>
      <?php if($this->Session->check('success')){ ?>
         ...
         <div class="content-box content-box-header search_list sales_total_pagination" style="border:none;">
			<?php
				echo $this->element('backend/Members/customers_list');
			?>
			</div>
